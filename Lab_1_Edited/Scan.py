...
files = "/home/mangesh/Downloads/malware_data_science/ch8/data/benignware/agentsvr.exe"
...
proc = sp.Popen(["/home/mangesh/Downloads/capa", "-v", files], stdout=sp.PIPE, universal_newlines=True)
