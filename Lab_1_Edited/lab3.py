...
# Convert the dataset to integer values
...
graph = graphviz.Source(dot_data) # Create graph from dot data and save it in a file named tree.png
graph.render("dataset", format="png") # Render the graph in png format and save it in a file named dataset
